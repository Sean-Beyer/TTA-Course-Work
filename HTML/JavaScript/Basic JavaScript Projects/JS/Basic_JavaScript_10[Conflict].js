...
// return
function funkatron(name) {
    return "Hello " + name;
}
document.getElementById("return").innerHTML = funkatron("Sean");
...
let kapp = {
    ...
    description : function() {
        return "kAPP is a " + this.race + this.class + " with his trusty " + this.ai;
    }
};
document.getElementById("kapp_object").innerHTML = kapp.description();