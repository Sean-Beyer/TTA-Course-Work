...
#           Demonstrating how to pass variables from function to furnction
...
def describe_game(name):
    """
        ...
        If it is not a new game, thank player for
...
def score(nice,mean,name):
    # soore function is being passed the values stored within the 3 variables
